...
public class EntityFactory {
    ...
    public SnakeHead buildSnakeHead(Position pos) {
        ...
        double snakeArrowBuff = config.optDouble("snake_attack_arrow_buff", Arrow.DEFAULT_SNAKE_BUFF);
        double snakeTreasureBuff = config.optDouble("snake_health_treasure_buff", Treasure.DEFAULT_SNAKE_BUFF);
        double snakeKeyBuff = config.optDouble("snake_health_key_buff", Key.DEFAULT_SNAKE_BUFF);
        SnakeBuffs buffs = new SnakeBuffs(snakeArrowBuff, snakeTreasureBuff, snakeKeyBuff);
        return new SnakeHead(pos, snakeHealth, snakeAttack, buffs);
    }
    ...
    public MidnightArmour buildMidnightArmour() {
        ...
        return new MidnightArmour(midnightArmourDefence, midnightArmourAttack);
    }
    ...
    private Entity constructEntity(JSONObject jsonEntity, JSONObject config) {
        ...
        case "bomb":
            ...
            } else return new Bomb(pos, bombRadius);
